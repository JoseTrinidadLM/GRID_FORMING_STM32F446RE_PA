...
/*
 * ARM Cortex Mx Processor Priority ADDR Calculation
 */
...
#define SRAM1_BASE_ADDR			0x20000000UL //SRAM1 memory base address
#define SRAM2_BASE_ADDR			0x2001C000UL //SRAM2 memory base address
#define ROM_BASE_ADDR			0x1FFF0000UL //ROM memory base address
#define SRAM 					SRAM1_BASE_ADDR //SRAM memory

/*
 * Base ADDR of bus domains
 */
...
#define GPIOA_BASE_ADDR		AHB1PERIPH_BASE_ADDR
